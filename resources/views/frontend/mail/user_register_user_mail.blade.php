              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 30px 0;color:#153643;" align="left">
                    <h1 style="font-size:20px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Karuna - User Register</h1>
                  </td>
                ...
                <tr>
                  <td style="padding:0 0 30px 0;color:#153643;">
                    ...
                    <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Your request has been sent. Admin will approve your account. Have a great day!</p>
                  </td>
                </tr>
