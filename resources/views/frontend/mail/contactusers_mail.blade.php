              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                ...
                <tr>
                  <td style="padding:0 0 30px 0;color:#153643;">
                    <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">We appreciate you contacting us. Have a great day!</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0;">
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                      <tr>
                        <td style="width:30%;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Reply:</p>
                        ...
                        <td style="padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">{{ $details['reply'] }}</p>
