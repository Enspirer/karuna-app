            ...
            <div class="nav-container">
                <div class="nav-block">
                    <div class="navs navs-L">
                        <a href="{{route('frontend.mobile.index')}}" class="nav-link {{ Request::segment(2) == '' ? 'active' : null }}">
                        ...
                        <a href="{{route('frontend.mobile.notification')}}" class="nav-link {{ Request::segment(2) == 'notification' ? 'active' : null }}">
                    ...
                    <div class="navs navs-R">
                        <a href="{{route('frontend.mobile.profile_menu')}}" class="nav-link {{ Request::segment(2) == 'profile-menu' ? 'active' : null }}">
                        ...
                        <a href="{{route('frontend.mobile.profile')}}" class="nav-link {{ Request::segment(2) == 'profile' ? 'active' : null }}">
        ...
        <div class="inner-wrapper">
            <div class="mobile-container">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="{{route('frontend.mobile.donation_list')}}" class="nav-link {{ Request::segment(2) == 'donation-list' ? 'active' : null }}">
