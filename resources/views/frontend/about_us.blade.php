...
<section class="text-section">
    <div class="container">
        <div class="inner-wrapper">
            ...
            <div class="text">Based In the UK, We oversee a transparent process where donations from various parts of the world; are distributed to families affected in poverty; through our incorporated agents.</div>
        </div>
    </div>
</section>
...
<section class="about-feature-section">
    ...
    <div class="content-block">
        <div class="content-wrapper">
            ...
            <div class="text">We operate with a network of voluntary agents; that have dedicated their time and efforts to ensure that every donation is made impactful. Karunaa is a passionate endeavour to help Our Home-Sri Lanka; overcome the hardships & poverty afflicting our nation.</div>
        </div>
    </div>
</section>
...
<section class="agent-section">
    <div class="container">
        ...
        <div class="text">Join our network of Agents that have volunteered to make this pursuit a success. Note that we conduct a detailed systemized Selection Process.</div>
