<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ url('images/logo/karuna-logo-english.svg') }}" width="100" height="40" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ url('images/logo/karuna-logo-english.svg') }}" width="40" height="40" alt="CoreUI Logo">
    </a>
